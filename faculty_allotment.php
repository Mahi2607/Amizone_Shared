...
<body>
    <div class="container">
        ...
        <select name="selected_faculty" id="faculty">
        ...
        <?php
            ...
            {
                ?><option value=" <?php echo $user_details_details_row["USER_ID"]?>"> <?php echo $user_details_details_row["USER_NAME"]." [". $user_details_details_row["EMPLOYEE_CODE"]."]" ?> </option> <?php
            }
        ...
        <?php
            ...
            {
                ?><option value=" <?php echo $course_configuration_details_row["CONFIG_ID"]?>"> <?php echo $course_configuration_details_row["COURSE_NAME"]." [". $course_configuration_details_row["COURSE_CODE"]."]" ?> </option> <?php
            }
     ...
     <br>
            <input type="submit" value="Save" name="fallot">
  ...
  <tbody>
    ...
    while($row = mysqli_fetch_assoc($faculty_details))
    {
        ...
        ?> 
          <tr>
        <td> <?php echo $row["F_ALLOTMENT_ID"] ?> </td>
